...
// add button space to start and stop
...
class Clockface extends React.Component {
    ...
    // add a a function to start the countdown    
        ...
        render() {
           ...
           <div>                
             ...
             Break Length
             <div>
             <button className="btn arrow this" id="breakincrease" onClick={this.increment}><i class="fas fa-angle-double-up"></i> + </button>
